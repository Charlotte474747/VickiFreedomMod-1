...
@CommandParameters(description = "Mutes a player and admins with brute force.", usage = "/<command> [[-s] <player> [reason] | list | purge | all]", aliases = "mute")
public class Command_astfu extends FreedomCommand
{
